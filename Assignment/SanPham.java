...
import Assignment.NhomHang;
import Assignment.SanPham;
...
public class SanPham {
    ...
    public void nhapSanPham(NhomHang nhomHang) {
        ...
        do {
            try {
                System.out.println("Nhap gia goc cua san pham: ");
                this.giaNhap = sc.nextFloat();
            } catch (Exception e) {
                System.out.println("GIA CUA SAN PHAM PHAI LA SO (KO PHAI KY TU)");
                sc.nextLine();
            }
